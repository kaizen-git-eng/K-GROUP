document.addEventListener('DOMContentLoaded', () => {
    ...
    const UI = {
        ar: {
            ...
            hero: {
                badge: 'هوية مطبوعة بشكل فاخر', titleLine1: 'عندما تلتقي الحِرفة بالجمال', titleLine2: 'يولد منتجك بأفضل صورة',
                description: 'K GROUP يقدم حلول طباعة مخصصة للشركات والبراندات والأفراد، مع مزامنة مباشرة لكل التعديلات والطلبات عبر السحابة.',
                ctaPrimary: 'تصفح المنتجات', ctaSecondary: 'شاهد أعمالنا',
                point1: 'تحديثات فورية لكل المستخدمين', point2: 'طلبات مباشرة عبر واتساب', point3: 'حسابات مستخدمين وطلبات محفوظة',
                previewTitle: 'واجهة راقية لمنتجات الطباعة', previewTitleSmall: 'تجربة ثنائية اللغة', previewText: 'منتجات دعائية وتجارية بجودة تليق بعلامتك التجارية.', previewPhone: 'مزامنة فورية عبر Supabase'
            },
            feature: {
                oneTitle: 'تحديث لحظي', oneText: 'أي تعديل على المنتجات أو الحذف أو الإضافة يظهر فورًا لباقي المستخدمين.',
                twoTitle: 'حسابات مستخدمين', twoText: 'كل عميل يمكنه إنشاء حسابه وتسجيل الدخول من أي جهاز.',
                threeTitle: 'طلبات محفوظة', threeText: 'طلبات الشراء المسجلة تظهر للأدمن داخل لوحة الإدارة.'
            },
            auth: {
                signup: 'إنشاء حساب', login: 'تسجيل الدخول', logout: 'تسجيل الخروج',
                signupTitle: 'إنشاء حساب جديد', signupSubtitle: 'سجّل اسمك ورقم هاتفك وكلمة المرور لحفظ طلباتك ومزامنتها بين الأجهزة.',
                loginTitle: 'تسجيل دخول المستخدم', loginSubtitle: 'استخدم رقم الهاتف وكلمة المرور للدخول إلى حسابك من أي جهاز.',
                accountRequired: 'يجب إنشاء حساب أو تسجيل الدخول أولًا لإرسال طلب شراء.',
                welcomePrefix: 'مرحبًا', accountCreated: 'تم إنشاء الحساب بنجاح.', accountCreatedVerify: 'تم إنشاء الحساب. إذا كان مشروعك يفعّل تحقق الهاتف، أكمل التحقق ثم سجّل الدخول.',
                loggedIn: 'تم تسجيل دخولك بنجاح.', loggedOut: 'تم تسجيل خروج حساب العميل.'
            },
            products: {
                eyebrow: 'المنتجات', title: 'منتجات قابلة للطباعة', subtitle: 'جميع المنتجات هنا تُدار من قاعدة البيانات وتظهر تحديثاتها مباشرة لكل الزوار.',
                searchPlaceholder: 'ابحث باسم المنتج...', emptyTitle: 'لا توجد منتجات متاحة.', emptyText: 'يمكنك إضافة منتجات من لوحة الإدارة لتظهر هنا.', noMatchTitle: 'لا توجد نتائج مطابقة.', noMatchText: 'جرّب تغيير كلمة البحث أو القسم المحدد.',
                resetFilters: 'إعادة ضبط الفلاتر', all: 'الكل', quoteTag: 'عرض سعر عند الطلب', viewDetails: 'عرض التفاصيل'
            },
            portfolio: {
            ...
            methods: {
                eyebrow: 'طرق الطباعة', title: 'تقنيات تناسب كل منتج', subtitle: 'اختر الطريقة المناسبة حسب نوع الخامة وشكل التنفيذ المطلوب.',
                uvTitle: 'طباعة UV', uvText: 'مناسبة للأسطح الصلبة مع ألوان واضحة وتشطيب أنيق.',
                screenTitle: 'سيلك سكرين', screenText: 'اختيار ممتاز للتيشيرتات والمنتجات الكمية بطبقات حبر قوية.',
                dtfTitle: 'DTF / DTG', dtfText: 'للتصاميم الملونة والتفاصيل الدقيقة على الملابس والأقمشة.',
                laserTitle: 'ليزر', laserText: 'نقش نظيف ودقيق على الخشب والمعادن وبعض الخامات الخاصة.',
                embTitle: 'تطريز', embText: 'لمسة فاخرة ومتينة تناسب الملابس والقبعات والزي الرسمي.',
                transferTitle: 'هوت ترانسفير / فينيل', transferText: 'ممتاز للشعارات والأرقام والتطبيقات الخاصة على الملابس.'
            },
            footer: {
                about: 'حلول طباعة وهوية بصرية مخصصة بلمسة عصرية، مناسبة للشركات والمتاجر والفعاليات.', quickLinks: 'روابط سريعة', contact: 'تواصل معنا', owner: 'الإدارة', adminEntry: 'دخول لوحة الإدارة',
                copyright: '© 2026 K GROUP. جميع الحقوق محفوظة.', note: 'واجهة متصلة بالسحابة مع تحديثات مباشرة وحسابات مستخدمين.'
            },
            admin: {
                backToStore: 'العودة للمتجر', logout: 'تسجيل الخروج', ownerTitle: 'مالك المتجر', ownerSubtitle: 'جلسة إدارة نشطة',
                productsTab: 'إدارة المنتجات', categoriesTab: 'إدارة الأقسام', portfolioTab: 'إدارة الأعمال', usersTab: 'حسابات المستخدمين', ordersTab: 'طلبات الشراء',
                productsTitle: 'إدارة المنتجات', productsSubtitle: 'أضف أو عدّل أو احذف المنتجات المتزامنة مع كل المستخدمين.', addProduct: 'إضافة منتج', searchProductsPlaceholder: 'ابحث عن منتج...',
                table: { image: 'الصورة', name: 'الاسم', category: 'القسم', methods: 'طرق الطباعة', actions: 'الإجراءات' },
                emptyProductsTitle: 'لا توجد منتجات.', emptyProductsText: 'ابدأ بإضافة أول منتج ليظهر مباشرة في المتجر.',
                categoriesTitle: 'إدارة الأقسام', categoriesSubtitle: 'أضف أقسامًا عربية وإنجليزية لتظهر في الفلاتر والمنتجات.', addCategory: 'إضافة قسم', saveCategory: 'حفظ القسم', categoryList: 'قائمة الأقسام',
                portfolioTitle: 'إدارة الأعمال السابقة', portfolioSubtitle: 'أضف أو عدّل أمثلة التنفيذ التي تظهر للكل لحظيًا.', addPortfolio: 'إضافة عمل', emptyPortfolioTitle: 'لا توجد أعمال مضافة.', emptyPortfolioText: 'أضف أول عمل ليظهر ضمن قسم أعمالنا السابقة.',
                usersTitle: 'حسابات المستخدمين', usersSubtitle: 'الحسابات المسجلة من خلال الموقع تظهر هنا من أي جهاز.', usersSecurityNote: 'ملاحظة: كلمات المرور تُدار بأمان عبر Supabase Auth ولا يمكن عرضها كنص صريح داخل الواجهة.',
                usersTable: { name: 'الاسم', phone: 'رقم الهاتف', userId: 'معرف المستخدم', createdAt: 'تاريخ الإنشاء' }, emptyUsersTitle: 'لا توجد حسابات مستخدمين حتى الآن.', emptyUsersText: 'عندما يسجل المستخدمون من الموقع ستظهر بياناتهم هنا.',
                ordersTitle: 'طلبات الشراء والاقتباس', ordersSubtitle: 'كل طلب مسجل من المستخدمين يظهر هنا بشكل مباشر.',
                ordersTable: { customer: 'العميل', phone: 'الهاتف', product: 'المنتج', type: 'النوع', quantity: 'الكمية', printing: 'الطباعة', date: 'التاريخ' }, emptyOrdersTitle: 'لا توجد طلبات حالية.', emptyOrdersText: 'عند إرسال أي طلب من المستخدمين سيظهر هنا فورًا.',
                productFormSubtitle: 'أدخل بيانات المنتج باللغتين ليظهر بشكل احترافي لكل المستخدمين.', portfolioFormSubtitle: 'أضف مشروعًا منفذًا ليظهر في معرض الأعمال لكل المستخدمين.', filterAllCategories: 'كل الأقسام',
                ownerLoginTitle: 'دخول لوحة الإدارة', ownerLoginSubtitle: 'أدخل كلمة مرور الأدمن لفتح واجهة التحكم.'
            },
            forms: {
                categoryNameAr: 'اسم القسم بالعربية', categoryNameEn: 'اسم القسم بالإنجليزية', productName: 'اسم المنتج', customerName: 'اسم العميل', phone: 'رقم الهاتف', email: 'البريد الإلكتروني', quantity: 'الكمية المطلوبة', printingType: 'نوع الطباعة (اختياري)', notes: 'ملاحظات (اختياري)',
                productNameAr: 'اسم المنتج بالعربية', productNameEn: 'اسم المنتج بالإنجليزية', category: 'القسم', mainImage: 'رابط الصورة الرئيسية', shortDescAr: 'وصف مختصر بالعربية', shortDescEn: 'وصف مختصر بالإنجليزية', fullDescAr: 'الوصف الكامل بالعربية', fullDescEn: 'الوصف الكامل بالإنجليزية', methods: 'طرق الطباعة المتاحة', projectImage: 'رابط صورة مثال التنفيذ', projectDescAr: 'وصف مثال التنفيذ بالعربية', projectDescEn: 'وصف مثال التنفيذ بالإنجليزية', portfolioTitleAr: 'عنوان العمل بالعربية', portfolioTitleEn: 'عنوان العمل بالإنجليزية', portfolioMethodAr: 'طريقة الطباعة بالعربية', portfolioMethodEn: 'طريقة الطباعة بالإنجليزية', portfolioImage: 'رابط صورة العمل', portfolioDescAr: 'وصف العمل بالعربية', portfolioDescEn: 'وصف العمل بالإنجليزية'
            },
            details: { projectLabel: 'مثال من تنفيذ سابق', methodsTitle: 'طرق الطباعة المتاحة', requestQuote: 'اطلب عرض سعر', orderNow: 'اطلب الآن' },
            quote: {
                title: 'طلب عرض سعر', orderTitle: 'طلب شراء', subtitle: 'املأ البيانات التالية وسنفتح لك رسالة واتساب جاهزة.', orderSubtitle: 'سيتم حفظ الطلب في قاعدة البيانات ثم فتح رسالة واتساب جاهزة لك.', submit: 'إرسال عبر واتساب', orderSubmit: 'تسجيل الطلب وإرسال عبر واتساب', selectMethod: 'اختر طريقة الطباعة', noMethod: 'غير محدد', quoteType: 'عرض سعر', orderType: 'طلب شراء'
            },
            ...
            messages: {
                formRequiredTitle: 'بيانات ناقصة', formRequiredText: 'يرجى ملء كل الحقول المطلوبة.', methodsRequiredTitle: 'حدد طرق الطباعة', methodsRequiredText: 'اختر طريقة طباعة واحدة على الأقل.',
                loginSuccessTitle: 'تم الدخول', loginSuccessText: 'تم فتح لوحة الإدارة بنجاح.', loginErrorTitle: 'فشل الدخول', loginErrorText: 'كلمة المرور غير صحيحة.',
                productAddedTitle: 'تمت الإضافة', productAddedText: 'تمت إضافة المنتج بنجاح.', productUpdatedTitle: 'تم التحديث', productUpdatedText: 'تم تحديث بيانات المنتج بنجاح.', productDeletedTitle: 'تم الحذف', productDeletedText: 'تم حذف المنتج من المتجر.',
                categoryAddedTitle: 'تمت الإضافة', categoryAddedText: 'تمت إضافة القسم بنجاح.', categoryDeletedTitle: 'تم الحذف', categoryDeletedText: 'تم حذف القسم ونقل المنتجات التابعة له إلى قسم أخرى.', duplicateCategoryTitle: 'القسم موجود', duplicateCategoryText: 'هذا القسم موجود بالفعل.',
                portfolioAddedTitle: 'تمت الإضافة', portfolioAddedText: 'تمت إضافة العمل بنجاح.', portfolioUpdatedTitle: 'تم التحديث', portfolioUpdatedText: 'تم تحديث العمل بنجاح.', portfolioDeletedTitle: 'تم الحذف', portfolioDeletedText: 'تم حذف العمل من المعرض.',
                orderSavedTitle: 'تم حفظ الطلب', orderSavedText: 'تم تسجيل طلبك في النظام وفتحه على واتساب.', quoteSavedTitle: 'تم حفظ الطلب', quoteSavedText: 'تم تسجيل طلبك وربطه بحسابك.', openWhatsappTitle: 'فتح واتساب', openWhatsappText: 'جاري تجهيز الرسالة وفتح واتساب...',
                deleteProductConfirmTitle: 'حذف المنتج', deleteProductConfirmText: 'هل أنت متأكد من حذف هذا المنتج؟', deleteCategoryConfirmTitle: 'حذف القسم', deleteCategoryConfirmText: 'هل أنت متأكد من حذف هذا القسم؟', deletePortfolioConfirmTitle: 'حذف العمل', deletePortfolioConfirmText: 'هل أنت متأكد من حذف هذا العمل؟', logoutConfirmTitle: 'تسجيل الخروج', logoutConfirmText: 'هل تريد إنهاء جلسة الإدارة؟',
                supabaseWarningTitle: 'تنبيه Supabase', supabaseWarningText: 'تعذر تحميل بعض الجداول من Supabase. تأكد من إنشاء الجداول وتفعيل الصلاحيات وRealtime.', authErrorTitle: 'تعذر تسجيل الدخول', authErrorText: 'تحقق من تفعيل Phone Auth في Supabase وصحة رقم الهاتف.', genericSaveError: 'حدث خطأ أثناء الحفظ.', genericLoadError: 'حدث خطأ أثناء تحميل البيانات.', adminUserRequiredTitle: 'مطلوب تسجيل الدخول', adminUserRequiredText: 'لكي تستخدم لوحة الإدارة مع Supabase يجب أولًا تسجيل الدخول بحساب مستخدم ثم إدخال كلمة مرور الإدارة.'
            }
        },
        en: {
            meta: {
            ...
            hero: {
                badge: 'Luxury printed identity', titleLine1: 'Where craftsmanship meets beauty', titleLine2: 'your product is born in its best form',
                description: 'K GROUP delivers custom printing solutions for companies, brands, and individuals with live cloud sync for products, accounts, and requests.',
                ctaPrimary: 'Browse Products', ctaSecondary: 'View Our Work',
                point1: 'Live updates for all users', point2: 'Direct WhatsApp requests', point3: 'User accounts and saved requests',
                previewTitle: 'Elegant interface for printing products', previewTitleSmall: 'Bilingual experience', previewText: 'Promotional and commercial products worthy of your brand.', previewPhone: 'Instant sync via Supabase'
            },
            feature: {
                oneTitle: 'Realtime Updates', oneText: 'Any product add, edit, or delete appears instantly for all users.',
                twoTitle: 'User Accounts', oneText2: '', twoText: 'Every customer can create an account and sign in from any device.',
                threeTitle: 'Saved Requests', threeText: 'Submitted purchase requests appear inside the admin panel.'
            },
            auth: {
                signup: 'Create Account', login: 'Login', logout: 'Logout', signupTitle: 'Create New Account', signupSubtitle: 'Register your name, phone number, and password to save orders and sync them across devices.',
                loginTitle: 'User Login', loginSubtitle: 'Use your phone number and password to access your account from any device.', accountRequired: 'You must create an account or log in before placing an order.',
                welcomePrefix: 'Hi', accountCreated: 'Account created successfully.', accountCreatedVerify: 'Account created. If your project requires phone verification, complete it and then sign in.', loggedIn: 'You are now logged in.', loggedOut: 'Customer account logged out.'
            },
            products: {
    ...
    function getNestedValue(object, path) {
        return path.split('.').reduce((acc, part) => acc && acc[part] !== undefined ? acc[part] : null, object);
    }
    ...
    function getMethodLabel(methodId) {
        ...
        return method ? (state.language === 'ar' ? method.ar : method.en) : methodId;
    }
    ...
    function closeModal(modal) {
        ...
        const openModals = [...document.querySelectorAll('.modal')].some(item => !item.classList.contains('hidden'));
    ...
    function requireSignedInUserForAdminData() {
        if (state.currentUser) return true;
        showToast('error', t('messages.adminUserRequiredTitle'), t('messages.adminUserRequiredText'));
        return false;
    }
    ...
    function getProductProjectDesc(product) {
    ...
    function getPortfolioDesc(item) {
    ...
    function applyTranslations() {
        ...
        const languageLabel = state.language === 'ar' ? 'EN' : 'عربي';
        refs.languageToggleLabel.textContent = languageLabel;
        refs.mobileLanguageToggleLabel.textContent = languageLabel;
        refs.adminLanguageToggleLabel.textContent = languageLabel;
    ...
    function updateAuthUI() {
        const guestVisible = !state.currentUser;
        ...
        const name = state.currentProfile?.full_name || state.currentUser?.user_metadata?.full_name || state.currentUser?.phone || t('common.guest');
    ...
    function buildPrintingMethodCheckboxes(selectedMethods = []) {
        refs.printingMethodCheckboxes.innerHTML = PRINTING_METHODS.map(method => `
            <label class="check-item">
                ...
                <span>${escapeHtml(state.language === 'ar' ? method.ar : method.en)}</span>
            </label>
        `).join('');
    }
    ...
    function renderProducts() {
        ...
        refs.productsGrid.querySelectorAll('.product-card, .view-product').forEach(item => {
        ...
        refs.portfolioGrid.innerHTML = state.portfolio.map(item => `
            <article class="portfolio-card">
                ...
                <div class="portfolio-body">
                    ...
                    <p>${escapeHtml(getPortfolioDesc(item))}</p>
                </div>
            </article>
        `).join('');
    }
    ...
    function openProductDetails(productId) {
        ...
        refs.detailsProjectDescription.textContent = getProductProjectDesc(product);
    ...
    function prepareQuoteModal(productId, mode = 'quote') {
        ...
        const profileName = state.currentProfile?.full_name || state.currentUser?.user_metadata?.full_name || '';
        const profilePhone = state.currentProfile?.phone || state.currentUser?.phone || '';
        refs.quoteCustomerName.value = profileName;
        refs.quotePhone.value = profilePhone;
    ...
    async function ensureProfileFromUser(user) {
        ...
        const payload = {
            id: user.id,
            full_name: user.user_metadata?.full_name || state.currentProfile?.full_name || user.phone || 'User',
        ...
        updateAuthUI();
        if (state.adminAuthenticated) await loadUsersAndOrders();
    }
    ...
    async function initializeAuth() {
        ...
        if (state.currentUser) await ensureProfileFromUser(state.currentUser);
        updateAuthUI();

        supabaseClient.auth.onAuthStateChange(async (_event, session) => {
            state.currentUser = session?.user || null;
            if (state.currentUser) {
                await ensureProfileFromUser(state.currentUser);
            } else {
    ...
    function initializeRealtime() {
        ...
        state.realtimeChannel = supabaseClient
            ...
            .on('postgres_changes', { event: '*', schema: 'public', table: 'categories' }, async () => {
                const data = await safeSelect('categories', mapCategoryRow, state.categories);
                state.categories = data.length ? data : state.categories;
                if (!state.categories.some(category => category.id === 'other')) state.categories.push({ id: 'other', nameAr: 'أخرى', nameEn: 'Other' });
                populateCategorySelects();
                renderCategoryPills();
                renderProducts();
                renderAdminCategories();
    ...
    async function signUpUser(name, phone, password) {
        ...
        if (data.user && data.session) {
            ...
            showToast('info', t('auth.signup'), t('auth.accountCreatedVerify'));
        }
    ...
    async function deleteProduct(productId) {
        if (!supabaseClient) return;
        if (!requireSignedInUserForAdminData()) return;
    ...
    async function saveRequestFromForm() {
        ...
        if (requestType === 'order' && !state.currentUser) {
    ...
    refs.customerLogout.addEventListener('click', signOutUser);
    refs.mobileCustomerLogout.addEventListener('click', async () => {
        closeMobileMenu();
        await signOutUser();
    });
    ...
    refs.userLoginForm.addEventListener('submit', async event => {
        ...
        const password = refs.userLoginPassword.value;
        if (!phone || !password) {
            showToast('error', t('messages.formRequiredTitle'), t('messages.formRequiredText'));
            return;
        }
    ...
    refs.loginForm.addEventListener('submit', event => {
        ...
        if (refs.adminPassword.value === ADMIN_PASSWORD) {
            ...
            if (!state.currentUser) {
                showToast('info', t('messages.adminUserRequiredTitle'), t('messages.adminUserRequiredText'));
            }
        } else {
